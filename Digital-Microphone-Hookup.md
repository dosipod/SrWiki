...
Some I2S ADC boards expect a MCLK ("Master Clock" aka "Memory Clock" aka "System Clock") signal. For these boards, use our `Generic I2S with MCLK` input driver, and connect MCLK to GPIO pin 0, 1, or 3.
