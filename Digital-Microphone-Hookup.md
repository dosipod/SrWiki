...
ESP32 pins in the table are just examples. In fact **any** available GPIO can be used for I²S on ESP32. SD can also be an input-only pin > 34, while WS and SCK *must* be in/out pins < 34.
