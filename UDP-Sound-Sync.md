...
You might want to take a look at this library, that allows to [send and receive WLED Audio Sync data](https://github.com/netmindz/WLED-sync) independent from WLED.
